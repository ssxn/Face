...
//			由于华为的手机和小米的手机的绘制坐标原点不同,故有所改变_自定义view层面
			myView_x = (int)(myViewWidth - (sourceBottom+D_value_of_horizatal));
			myView_y = (int)(myViewHeight -( sourceRight+D_value_of_vertical));
...
//				Bitmap bmp = Bitmap.createBitmap(resourceBitmap, 0, 0, 200, 200);
				return bmp;
			}
		}
		return null;
